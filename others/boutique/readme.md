...
npm run dev-server
```
3. le fait de synchroniser l'augmentation des produits selectionés est ce qui m'a pris largement de temps car je n'ai pas fait attention avec un Nan qui se produit, mais a la fin j'ai pu le faire et j'ai terminé le projet en entier.
  **Tous marchent comme il faut.**