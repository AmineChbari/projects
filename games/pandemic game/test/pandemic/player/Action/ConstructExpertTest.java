...
public class ConstructExpertTest {
	private Board board;
	...
	public void init() {
		...
		this.construct = new ConstructExpert(board);
	}
	...
	public static junit.framework.Test suite() {
		return new junit.framework.JUnit4TestAdapter(pandemic.player.Action.ConstructExpertTest.class);
	}
}
