...
public class CureScientistTest {
	private Board board;
	private Action cure;
	private City city1;
	private Player p;
	...
	public void init() {
		...
		this.cure = new CureScientist(this.board);
	...
	public void doSomethingTest() {
		...
		Collections.addAll(cards, c1, c2, c3, c4, c21, c22, c23, c24, c31, c32, c33, c34, c41, c42, c43, c44);
		p.setCards(cards);
	...
	public void isGameWinTest() {
		...
		Disease.JAUNE.setCured(false);
		try {
			CureScientist.isGameWin();
		} catch (GameWinException e) {
			fail("Throws exception");
		}
		Disease.NOIR.setCured(true);
		Disease.ROUGE.setCured(true);
		Disease.BLEU.setCured(true);
		Disease.JAUNE.setCured(true);
		try {
			CureScientist.isGameWin();
	...
	public void toStringTest() {
		assertEquals("Scientist Curing", this.cure.toString());
	}

	
	public static junit.framework.Test suite() {
		return new junit.framework.JUnit4TestAdapter(pandemic.player.Action.CureScientistTest.class);
	}
}
